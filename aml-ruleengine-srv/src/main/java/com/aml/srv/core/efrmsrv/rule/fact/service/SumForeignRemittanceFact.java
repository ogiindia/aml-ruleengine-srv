...
@Service("SUM_FOREIGN_REMITTANCESService")
public class SumForeignRemittanceFact implements FactInterface {
	...
	public ComputedFactsVO getFactExecutor(RuleRequestVo requVoObjParam, Factset factSetObj,
		...
		LOGGER.info("REQID : [{}]::::::::::::SumForeignRemittanceFact@getFactExecutor (ENTRY) Called::::::::::",
		...
		try {
			...
			LOGGER.info("REQID : [{}]::::::::::::SumForeignRemittanceFact@getFactExecutor (EXIT) End::::::::::\n\n",
					requVoObjParam.getReqId());
		}
