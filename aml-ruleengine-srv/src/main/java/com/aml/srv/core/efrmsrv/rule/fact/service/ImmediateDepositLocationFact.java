...
public class ImmediateDepositLocationFact implements FactInterface {
	...
	private Logger LOGGER = LoggerFactory.getLogger(ImmediateDepositLocationFact.class);
	...
	public ComputedFactsVO getFactExecutor(RuleRequestVo requVoObjParam, Factset factSetObj,
		...
		LOGGER.info("REQID : [{}]::::::::::::ImmediateDepositLocationFact@getFactExecutor (ENTRY) Called::::::::::",
		...
		try {
			...
			LOGGER.error("REQID : [{}] - Exception found in ImmediateDepositLocationFact@getFactExecutor : {}",requVoObjParam.getReqId(), e);
		} finally {
			LOGGER.info("REQID : [{}]::::::::::::ImmediateDepositLocationFact@getFactExecutor (EXIT) End::::::::::\n\n", requVoObjParam.getReqId());
		}
