...
@Service("FD_CONVERSIONService")
public class FDConversionFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(FDConversionFact.class);
