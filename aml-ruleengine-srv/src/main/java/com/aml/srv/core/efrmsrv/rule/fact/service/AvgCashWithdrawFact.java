...
public class AvgCashWithdrawFact implements FactInterface {
	...
	public ComputedFactsVO getFactExecutor(RuleRequestVo requVoObjParam, Factset factSetObj,
		...
		LOGGER.info("REQID : [{}]::::::::::::AvgCashWithdrawFact@getFactExecutor (ENTRY) Called::::::::::",
		...
		try {
			...
			/*
			 * TransactionDetailsDTO dto = transactionService.getTransactionDetails(reqId,
			...
			LOGGER.error("Exception found in AvgCashWithdrawFact@getFactExecutor : {}", e);
		} finally {
			LOGGER.info("REQID : [{}]::::::::::::AvgCashWithdrawFact@getFactExecutor (EXIT) End::::::::::\n\n", requVoObjParam.getReqId());
		}
