...
@Service("PREVIOUS_FOREX_TURNOVERService")
public class PreviousForexTurnOverFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(PreviousForexTurnOverFact.class);
