...
@Service("CASH_REPAYMENT_PERCENTAGEService")
public class CashRepaymentPercentageFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(CashRepaymentPercentageFact.class);
