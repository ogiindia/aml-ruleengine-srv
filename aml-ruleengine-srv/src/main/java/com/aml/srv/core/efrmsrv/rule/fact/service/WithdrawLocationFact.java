...
@Service("WITHDRAWAL_LOCATIONService")
public class WithdrawLocationFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(WithdrawLocationFact.class);
