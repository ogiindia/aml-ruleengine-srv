...
@Service("CREDIT_BALANCE_PERCENTAGEService")
public class CreditBalancePercetageFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(CreditBalancePercetageFact.class);
