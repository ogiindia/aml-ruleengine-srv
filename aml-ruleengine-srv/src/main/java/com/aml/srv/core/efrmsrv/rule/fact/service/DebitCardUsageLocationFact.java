...
@Service("DEBIT_CARD_USAGE_LOCATIONService")
public class DebitCardUsageLocationFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(DebitCardUsageLocationFact.class);
