...
@Service("TOTAL_REPAYMENTSService")
public class TotalRepaymentFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(TotalRepaymentFact.class);
