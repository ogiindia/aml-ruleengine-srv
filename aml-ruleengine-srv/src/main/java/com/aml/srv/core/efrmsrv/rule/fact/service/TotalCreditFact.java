...
public class TotalCreditFact implements FactInterface{
	...
	private Logger LOGGER = LoggerFactory.getLogger(TotalCreditFact.class);
	
	@Override
	public ComputedFactsVO getFactExecutor(RuleRequestVo requVoObjParam, Factset factSetObj,List<ComputedFactsVO> computedFacts ) {

		ComputedFactsVO computedFactsVOObj = null;
		LOGGER.info("REQID : [{}]::::::::::::TotalCreditFact@getFactExecutor (ENTRY) Called::::::::::",
		...
		try {
			...
			LOGGER.error("Exception found in TotalCreditFact@getFactExecutor : {}", e);
		} finally {

			LOGGER.info("REQID : [{}]::::::::::::TotalCreditFact@getFactExecutor (EXIT) End::::::::::\n\n",
					requVoObjParam.getReqId());
		}
