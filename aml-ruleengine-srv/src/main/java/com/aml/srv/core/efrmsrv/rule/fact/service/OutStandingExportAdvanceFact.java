...
@Service("OUTSTANDING_EXPORT_ADVANCEService")
public class OutStandingExportAdvanceFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(OutStandingExportAdvanceFact.class);
