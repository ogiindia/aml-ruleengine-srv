...
@Service("SUM_NONCASH_WITHDRAWALService")
public class SumNonCashWithdrawFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(SumNonCashWithdrawFact.class);
