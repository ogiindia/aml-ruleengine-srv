...
@Service("ROUND_FIGURE_CHECKService")
public class RoundFigureCheckFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(RoundFigureCheckFact.class);
