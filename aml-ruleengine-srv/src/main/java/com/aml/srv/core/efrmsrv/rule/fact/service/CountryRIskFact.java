			...
			if (condition != null) {
				...
				if (dto != null && dto.getCounterContryCode() != null) {
					...
					if (condition != null && condition.equals("HIGH_RISK_COUNTRIES")) {
						...
						FS_FIUIndTerrorLocationEntity terrorLocationEntity = fS_FIUIndTerrorLocationRepoImpl
								.getCountryByritiria(requVoObjParam.getReqId(), dto.getCounterContryCode());
						if (terrorLocationEntity != null) {
							if (terrorLocationEntity.getCountry_Code() != null
									&& "IN".equals(terrorLocationEntity.getCountry_Code())) {
