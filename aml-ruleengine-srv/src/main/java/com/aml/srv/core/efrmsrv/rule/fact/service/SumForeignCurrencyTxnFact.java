...
@Service("SUM_FOREIGN_CURRENCY_TXNSService")
public class SumForeignCurrencyTxnFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(SumForeignCurrencyTxnFact.class);
