...
@Service("SUM_REMITTANCESService")
public class SumRemittanceFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(SumRemittanceFact.class);
