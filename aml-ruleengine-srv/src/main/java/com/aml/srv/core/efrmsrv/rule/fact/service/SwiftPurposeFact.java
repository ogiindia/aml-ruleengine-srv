...
@Service("SWIFT_PURPOSEService")
public class SwiftPurposeFact implements FactInterface{
	...
	private Logger LOGGER = LoggerFactory.getLogger(SwiftPurposeFact.class);
	
	@Override
	public ComputedFactsVO getFactExecutor(RuleRequestVo requVoObjParam, Factset factSetObj,List<ComputedFactsVO> computedFacts ) {

		ComputedFactsVO computedFactsVOObj = null;
		LOGGER.info("REQID : [{}]::::::::::::SwiftPurposeFact@getFactExecutor (ENTRY) Called::::::::::",
		...
		try {
			...
			if(condition!=null)
			{
			if (condition.equals("CONSULTANCY")) {
			...
			LOGGER.error("Exception found in SwiftPurposeFact@getFactExecutor : {}", e);
		} finally {

			LOGGER.info("REQID : [{}]::::::::::::SwiftPurposeFact@getFactExecutor (EXIT) End::::::::::\n\n",
					requVoObjParam.getReqId());
		}
