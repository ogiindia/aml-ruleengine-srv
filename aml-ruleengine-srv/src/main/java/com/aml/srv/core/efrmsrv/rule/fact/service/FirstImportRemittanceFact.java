...
@Service("FIRST_IMPORT_REMITTANCEService")
public class FirstImportRemittanceFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(FirstImportRemittanceFact.class);
