...
@Service("FRAUD_CASE_VALUEService")
public class FraudCaseFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(FraudCaseFact.class);
	...
	public ComputedFactsVO getFactExecutor(RuleRequestVo requVoObjParam, Factset factSetObj,
		...
		LOGGER.info("REQID : [{}]::::::::::::FraudCaseFact@getFactExecutor (ENTRY) Called::::::::::", requVoObjParam.getReqId());
		...
		try {
			...
			/*TransactionDetailsDTO dto = transactionService.getTransactionDetails(reqId, custId, accNo, null, null,
			...
			LOGGER.error("Exception found in FraudCaseFact@getFactExecutor : {}", e);
		} finally {

			LOGGER.info("REQID : [{}]::::::::::::FraudCaseFact@getFactExecutor (EXIT) End::::::::::\n\n",requVoObjParam.getReqId());
		}
