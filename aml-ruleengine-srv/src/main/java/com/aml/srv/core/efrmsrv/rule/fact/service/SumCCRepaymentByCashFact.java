...
@Service("SUM_CC_REPAYMENTS_CASHService")
public class SumCCRepaymentByCashFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(SumCCRepaymentByCashFact.class);
