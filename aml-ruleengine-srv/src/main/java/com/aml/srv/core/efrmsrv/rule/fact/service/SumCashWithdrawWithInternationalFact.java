...
@Service("SUM_CASH_WITHDRAWALS_INT_CARDService")
public class SumCashWithdrawWithInternationalFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(SumCashWithdrawWithInternationalFact.class);
