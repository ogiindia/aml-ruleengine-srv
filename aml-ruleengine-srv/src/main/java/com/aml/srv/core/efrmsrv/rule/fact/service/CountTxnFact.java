...
@Service("COUNT_TXNSSService")
public class CountTxnFact implements FactInterface {
	...
	private Logger LOGGER = LoggerFactory.getLogger(CountTxnFact.class);
	...
	public ComputedFactsVO getFactExecutor(RuleRequestVo requVoObjParam, Factset factSetObj,
		...
		LOGGER.info("REQID : [{}]::::::::::::CountTxnFact@getFactExecutor (ENTRY) Called::::::::::",
		...
		try {
			...
			/*dto = transactionService.getTransactionDetails(reqId, custId, accNo, txnId, null, transMode, days, months,
					factSetObj, range, hours);*/
