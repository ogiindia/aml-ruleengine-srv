...
public class MaxCashDepositFact implements FactInterface{
...
private Logger LOGGER = LoggerFactory.getLogger(SumDebitCreditFact.class);
	...
	public ComputedFactsVO getFactExecutor(RuleRequestVo requVoObjParam, Factset factSetObj,List<ComputedFactsVO> computedFacts ) {
		...
		LOGGER.info("REQID : [{}]::::::::::::MaxCashDepositFact@getFactExecutor (ENTRY) Called::::::::::",
		...
		try {
			...
			LOGGER.error("Exception found in MaxCashDepositFact@getFactExecutor : {}", e);
		} finally {

			LOGGER.info("REQID : [{}]::::::::::::MaxCashDepositFact@getFactExecutor (EXIT) End::::::::::\n\n",
					requVoObjParam.getReqId());
		}
