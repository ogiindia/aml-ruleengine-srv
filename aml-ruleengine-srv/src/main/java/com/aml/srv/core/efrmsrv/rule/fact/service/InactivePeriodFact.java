...
public class InactivePeriodFact implements FactInterface {
	...
	public ComputedFactsVO getFactExecutor(RuleRequestVo requVoObjParam, Factset factSetObj,
		...
		LOGGER.info("REQID : [{}]::::::::::::InactivePeriodFact@getFactExecutor (ENTRY) Called::::::::::",
				requVoObjParam.getReqId());
		String factName = null, accNo = null, custId = null, transMode = null, transType = null, txnTime = null,
				txnId = null, reqId = null;
		TransactionServiceSrchFieldVo trnsSrvSrchfldvo = null;
		try {
			...
			trnsSrvSrchfldvo = new TransactionServiceSrchFieldVo();
			
			trnsSrvSrchfldvo.setAccNo(accNo);
			trnsSrvSrchfldvo.setCustId(custId);
			trnsSrvSrchfldvo.setDays(days);
			trnsSrvSrchfldvo.setFactName(factName);
			trnsSrvSrchfldvo.setHours(hours);
			trnsSrvSrchfldvo.setMonths(months);
			trnsSrvSrchfldvo.setRange(range);
			trnsSrvSrchfldvo.setTransMode(transMode);
			trnsSrvSrchfldvo.setTransType(transType);
			...
			LOGGER.error("REQID : [{}] - Exception found in InactivePeriodFact@getFactExecutor : {}",requVoObjParam.getReqId(), e);
		} finally {
			LOGGER.info("REQID : [{}]::::::::::::InactivePeriodFact@getFactExecutor (EXIT) End::::::::::\n\n", requVoObjParam.getReqId());
		}
