...
@Service("SUM_FOREX_TURNOVERService")
public class SumForexTurnOverFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(SumForexTurnOverFact.class);
