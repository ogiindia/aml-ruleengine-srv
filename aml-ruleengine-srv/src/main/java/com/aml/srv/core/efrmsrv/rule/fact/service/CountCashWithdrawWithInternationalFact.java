...
@Service("COUNT_CASH_WITHDRAWALS_INT_CARDService")
public class CountCashWithdrawWithInternationalFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(CountCashWithdrawWithInternationalFact.class);
