...
@Service("OUTSTANDING_EXPORTSService")
public class OutStandingExportFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(OutStandingExportFact.class);
