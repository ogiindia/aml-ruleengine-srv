...
@Service("MIN_CREDIT_BALANCEService")
public class MinCreditBalanceFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(MinCreditBalanceFact.class);
