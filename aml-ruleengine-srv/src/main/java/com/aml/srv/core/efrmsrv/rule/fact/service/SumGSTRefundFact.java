...
public class SumGSTRefundFact implements FactInterface{
	...
	private Logger LOGGER = LoggerFactory.getLogger(SumGSTRefundFact.class);
	
	@Override
	public ComputedFactsVO getFactExecutor(RuleRequestVo requVoObjParam, Factset factSetObj,List<ComputedFactsVO> computedFacts ) {

		ComputedFactsVO computedFactsVOObj = null;
		LOGGER.info("REQID : [{}]::::::::::::SumGSTRefundFact@getFactExecutor (ENTRY) Called::::::::::",
		...
		try {
			...
			LOGGER.error("Exception found in SumGSTRefundFact@getFactExecutor : {}", e);
		} finally {

			LOGGER.info("REQID : [{}]::::::::::::SumGSTRefundFact@getFactExecutor (EXIT) End::::::::::\n\n",
					requVoObjParam.getReqId());
		}
