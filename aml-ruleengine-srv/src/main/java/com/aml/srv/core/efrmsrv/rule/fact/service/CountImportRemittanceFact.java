...
@Service("COUNT_IMPORT_REMITTANCESService")
public class CountImportRemittanceFact implements FactInterface{


	private Logger LOGGER = LoggerFactory.getLogger(CountImportRemittanceFact.class);
